package br.com.fiap.trabalhomobile.ui.signup
...
import br.com.fiap.trabalhomobile.model.User
...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun saveInRealTimeDatabase() {
        val user = User(inputEmail.text.toString(), inputPassword.text.toString())
